-- File: audit_log.sql
-- Purpose: To define a table for logging changes made to records in the database, including the type of operation performed.
-- This log will help in tracking modifications and maintaining an audit trail for data integrity and accountability.
-- ===============================================================
...
CREATE TABLE audit_log (
    ...
    PRIMARY KEY (log_id),
    INDEX idx_table_name (table_name) COMMENT 'Index to optimize queries filtering by table_name',
    INDEX idx_record_id (record_id) COMMENT 'Index to speed up lookups on record_id for tracking changes'
);
